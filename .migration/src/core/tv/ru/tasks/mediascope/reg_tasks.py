...
from core.tv.ru.tasks.mediascope.params.filters import BreakFilter, DateFilter, Region
...
def reg_affinity_task(
    ...
    options: dict[str, Any] = {
        Options.KIT_ID.value: KitIds.TV_INDEX_CITIES.value,
        Options.ISSUE_TYPE.value: IssueTypes.BREAK.value,
    }
    slices = [
        ChannelSlices.REGION_NAME.value,
    ...
    breaks_filter = BreakFilter(
        ...
        break_distribution_type=['L'],  # Распространение 'Локальное'
    )
    ...
    df = (
        ...
        .sort(
            ...
            [
                pl.col(ChannelSlices.REGION_NAME.value),
        ...
        .rename(
            {
                ChannelSlices.REGION_NAME.value: 'Регион',
