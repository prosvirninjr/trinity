...
reg_base_task_dialog = Dialog(
    Window(
        ...
        state=states.RegBaseTaskSG.window_start,
    ),
)

# Диалог для выгрузки Affinity
reg_affinity_task_dialog = Dialog(
    Window(
        ...
        state=states.RegAffinityTaskSG.window_audience,
    ),
    Window(
        ...
        state=states.RegAffinityTaskSG.window_start_date,
    ),
    Window(
        ...
        Cancel(Const('✗ Отмена'), id='_cancel', on_click=handlers.handle_cancel),
        state=states.RegAffinityTaskSG.window_end_date,
    ),
    Window(
        ...
        Cancel(Const('✗ Отмена'), id='_cancel', on_click=handlers.handle_cancel),
        state=states.RegAffinityTaskSG.window_confirm,
